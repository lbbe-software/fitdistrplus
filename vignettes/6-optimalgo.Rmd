...
```{r}
unconstropt <- fitbench(x, "beta", "mle", grlnL) 
```
...
constropt <- fitbench(x, "beta", "mle", grlnL, custom.optim=constrOptim2, ui = diag(2), ci = c(0, 0)) 
```
...
names(reslist) <- paste("exp.", fullname)
```
