...
Consider the normal distribution $\calN(\mu, \sigma^2)$
defined by the density
$$
f(x) = \frac{1}{\sqrt{2\pi\sigma^2}}\exp\left(-\frac{(x-\mu)^2}{2\sigma^2}\right),
x\in\R,
$$
where $\mu$ is a location parameter such that $\mu\in\R$,
...
Consider the Burr distribution $\calB(\mu, \sigma^2)$
defined by the density
$$
...
Consider the geometric distribution $\calG(p)$
...
Consider the shifted exponential distribution $\calE(\mu,\lambda)$
defined by the mass probability function
$$
...
$\mu$ is a boundary (or shift) parameter such that $\mu\in\R$.
