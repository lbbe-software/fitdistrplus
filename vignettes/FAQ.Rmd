...
in a global fashion near the centre of the distribution but the Anderson-Darling test 
...
distribution of mean parameter equal to 1 (to a sufficiently high value to consider that the
Poisson distribution could be apprximated by a normal one). Using a Kolmogorov-Smirnov
...
## Can we compute marginal confidence intervals on parameter estimates from their reporterd standard error ?
