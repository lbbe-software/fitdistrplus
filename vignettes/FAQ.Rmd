...
result of this test is subject to caution. 

If there is no general asymptotic theory for the Kolmogorov-Smirnov
statistics in case of a fitted distribution, such a one was proposed for some distributions for quadratic statistics
...
exponential, gamma, Weibull, logistic distributions. The user can refer to the cited book and use the proposed
...
between empirical and theoretical distribution functions. But as mentioned in the main vignette of our package,
...
Theoretically such a test can also be used for fits on censored data. In any case
such a test should be used on small data sets.
...
# Questions regarding uncertainty on parameter estimates
...
to the ones obtained using the bootstrap procedure (see below) before using this approximation. A look
