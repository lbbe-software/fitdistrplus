...
method assumes that  $u=\hat u$ and $l=\hat l$ are known; whereas the third method
maximizes the log-likelihood on the subset $y_i$ such that $l<y_i<u$.
The first and the second methods give exactly the same result.
...
f1 <- fitdist(x, "texp", method="mle", start=list(rate=1/mean(x), low=.1, upp=1e1))
