...
mledist2 <- function (data, distr, start=NULL, fix.arg=NULL, optim.method="default", 
    ...
    # a dataframe of two columns named left and right for censored data 
{
    ...
    start.arg <- start #to avoid confusion with the start() function of stats pkg
    #if(is.null(start.arg))
    #  start.arg <- function(x) start.arg.default(x, distr=distr)
