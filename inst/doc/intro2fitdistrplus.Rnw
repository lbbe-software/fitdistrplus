...
% A changer en cas de mise à jour de fitdistrplus !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
between parameter estimates, the loglikelihood, the Akaïke and the Schwarz information criteria 
...
% Ajouter ex endosulfan avec la bibliothèque actuar !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
% mais comment faire dans la vignette : indiquer que fitdistrplus nécessite actuar????????????????????????????
